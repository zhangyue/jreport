...
import pers.yue.jreport.exceptions.ExceedingBoundaryException;
...
import static pers.yue.jreport.util.StringUtil.toLong;
...
public class FileUtil {
    ...
    public static long sizeStrToLong(String sizeStr) {
        ...
        if(sizeStr.contains("KB")) {
            size = toLong(sizeStr.replace("KB", "")) * KB;
        } else if(sizeStr.contains("MB")) {
            size = toLong(sizeStr.replace("MB", "")) * MB;
        } else if(sizeStr.contains("GB")) {
            size = toLong(sizeStr.replace("GB", "")) * GB;
        } else if(sizeStr.contains("TB")) {
            size = toLong(sizeStr.replace("TB", "")) * TB;
        }
        return size;
    }
