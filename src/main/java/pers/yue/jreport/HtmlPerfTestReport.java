...
import pers.yue.jreport.util.testutil.FileTestUtil;
...
import static pers.yue.jreport.util.StringUtil.getClassSimpleName;
            ...
            for(TestClassResult testClassResult : testPackageResult.getTestClassResults()) {
                ...
                for (TestResult testResult : testResults) {
                    ...
                    File statResultFile = new File(outputDirectoryName + File.separator +
                            getClassSimpleName(testClassResult.getTestClassName()) + File.separator + testResult.getName());
